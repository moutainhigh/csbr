package com.csbr.qingcloud.config.server.controller;
...
public class MysqlGenerator {
    ...
    private static final String[] tableName = new String[]{"tr_in_bound_result_detail","tr_out_bound_result_detail"};
