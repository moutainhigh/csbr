 ...
 */
@RestController
@RequestMapping("/ms-hy-server/trInBoundResultDetail")
@Api(tags = {"入库明细"})
public class TrInBoundResultDetailController {

    @Autowired
    private TrInBoundResultDetailService trInBoundResultDetailService;
    ...
    @GetMapping("get-in-bound-result-select")
    @ApiOperation(value = "入库历史汇总查询")
    @ApiImplicitParams({
    ...
    public CommonRes getInBoundResultSelect(
        ...
        try {
            ...
            Map<String, Object> inBoundResultSelect = trInBoundResultDetailService.getInBoundResultSelect(params);
            return CommonRes.ok("success",inBoundResultSelect);
        }catch (Exception e){
     ...
     */
    @SentinelResource(value = "sentile-rule")
    @GetMapping("get-in-bound-result-detail-select")
    @ApiOperation(value = "入库历史明细查询")
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "query", required = true, name = "tenantGuid", dataType = "String", value = "租户信息"),
            @ApiImplicitParam(paramType = "query", required = true, name = "pageIndex", dataType = "int", value = "当前页"),
            @ApiImplicitParam(paramType = "query", required = true, name = "pageSize", dataType = "int", value = "每页显示数"),
    ...
    public CommonRes getInBoundResultDetailSelect(
        ...
        try {
            ...
            params.put("lot",lot);
            Map<String, Object> inBoundResultDetailSelect = trInBoundResultDetailService.getInBoundResultDetailSelect(params);
            return CommonRes.ok("success",inBoundResultDetailSelect);
        }catch (Exception e){
            return CommonRes.ok(e.getMessage());
        }
    }
