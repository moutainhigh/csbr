...
@Mapper
@Repository
public interface PTransrouteSumMapper extends BaseMapper<PTransrouteSum> {
    /**
     * 查询信息.
     *
     * @param so 查询条件
     ...
     * @return 查询结果
     */
    List<PTransrouteSum> searchPTransrouteSums(PTransrouteSumSO so);
     ...
     * @return
     */
    PTransrouteSum searchPTransrouteSum(PTransrouteSumSO so);
}
